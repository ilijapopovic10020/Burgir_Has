            ...
            <div class="col-sm-6 col-md-6 col-lg-5 shadow-lg p-3">
                ...
                <form>
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control" id="foodName" placeholder="Unesite naziv proizvoda">
                    </div>
                    <div class="form-group my-3">
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea class="form-control" id="foodDesc" rows="3" placeholder="Unesite opis proizvoda"></textarea>
                    </div>
                    <div class="form-group my-3">
                        <label for="foodPrice">Cena proizvoda</label>
                        <input type="number" class="form-control" id="foodPrice" placeholder="Unesite cenu proizvoda">
                    </div>
                    <div class="form-group my-3">
                        <label for="foodKcal">Broj kcal</label>
                        <input type="number" class="form-control" id="foodKcal" placeholder="Unesite broj kcal">
                    </div>
                    <div class="form-group my-3">
